...
The system SHALL provide a videos section containing at least two lessons: one teaching ASL signs for the letters and one teaching ASL signs for the numbers. Each lesson SHALL be delivered in Indonesian (spoken narration). When Indonesian caption tracks are available, the system SHALL let the student turn them on for accessibility.
...
#### Scenario: Captions available and enabled
- **WHEN** an Indonesian caption track exists for a lesson and the student enables captions
